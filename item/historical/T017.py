...
class AtoWorkbook:
            ...
            for new_key, new_val in value.items():
                if new_key == "name":
                    ...
                    for index in range(list_length):
                        if "Freight Vehicle registration" in dataset_name_split[index]:
                            valid_id_found = True
                            rule_id = key
                            break    
                        else:
    ...
    def get_vehicle_type(self, mode:str, item_value: dict , dataset_name: str):
        ...
        ============================================= ===== ============
        """
        # Dataset name: Freight Vehicle registration
    ...
    def get_variable_type(self, service_name: str, indicator_name: str):
        ...
        if service_name ==  "Freight":
            ...
            elif "Freight Vehicle registration" in indicator_name:
                variable = "Stock"
    ...
    def process_input_data(self):
        ...
        df = pd.read_excel(open(self.workbook_file, 'rb'),sheet_name=self.sheet_name)
...
def get_input_files():
    ...
    excel_file_path = os.path.abspath(os.path.join(submodule_path, 'data', 'historical', 'input', 'T017_input.xlsx'))
