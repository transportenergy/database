...
# Object to indicate ID columns that may report "All" and possibly the sub-components necessary to re-construct "All"
ITEM_IDVARS_WITH_ALLS <- c("region", "mode", "technology", "fuel")
