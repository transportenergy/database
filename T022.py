...
class AtoWorkbook:
    ...
    #                     if "Vehicle registration(LDV)" in dataset_name_split[index]:
    #                         valid_id_found = True
    #                         rule_id = key
    #                         break    
    #                     else:
    ...
    def get_rule_id(self, rule_book: dict):
        ...
        for key, value in rule_book.items():
            if value.get("Service") == "Passenger" and value.get("name") == "Vehicle registration(LDV)":
                rule_id = key
                valid_id_found = True
                break

        return rule_id, value, value.get("name")
    ...
    def get_variable_type(self, service_name: str, indicator_name: str):
        ...
        ============================================= ===== ============
        """
        variable = "Stock"  # Default value

        if service_name == "Passenger" and "Vehicle registration(LDV)" in indicator_name:
            variable = "Stock"
    ...
    #     The unit is changed from: " The unit is: "Number to 10^6 vehicle"
    #     # Unit: "Number to 10^6 vehicle"
    #     ============================================= ===== ============
    #     """
    #     unit = "NA"
    #     unit_factor = 1     
    ...
    #     The unit is changed from: "Number to 10^6 vehicle"
    #     # Unit: "Number to 10^6 vehicle"
    #     ============================================= ===== ============
    #     """
    #     unit = "NA"
    ...
    #                     break
    #     if unit_found:
    #         print(f"The unit is changed from: '{unit_name}' to '{unit}'.")
    #     else:
    ...
    def process_input_data(self, workbook_file: str, master_file: str, regions_file: str, source_file: str):
        ...
        df = pd.read_excel(open(workbook_excel_file, 'rb'),sheet_name='TAS-VEP-017')
